        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <button class="btn btn-success" type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-Distributer" title="Add new User"><i class="fa fa-plus"></i></button>
              <br>
              <?php session_message(); ?>
              <?php error_message(); ?>
            </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-responsive">
                ...
                <tbody>
                <?php
                $query_show = "SELECT * FROM distributer";
                $i=1;
...
<!-- jQuery 3 -->
<div class="modal fade" id="modal-Distributer">
          ...
          <form  method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="row">
              ...
              <div class="col-md-10">
                ...
                <input type="text" placeholder="Phone No" class="form-control" name="phone_no" required="" data-inputmask='"mask": "+99(999)-9999999"' data-mask placeholder="Distributer Phone No">
                <label>CNIC</label>
