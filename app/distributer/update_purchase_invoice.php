...
$time = $row["created_at"];
$transection_record = "SELECT * FROM transection_details  where invoice_id= '$id' AND type='purchase'";
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
			<div class="row">
	      	...
	      	<div class="col-md-8">
	            ...
	            <div class="box-header">
	              <h2 style="text-align: center"><b><i>Update Purchase Invoice</i></b></h2>
            ...
            <div class="box-body">
              ...
              <?php
              while ($trans_record = mysqli_fetch_assoc($result_transection)) {
              $trans_id = $trans_record["id"];
}
                if (isset($_POST["update"])) {
                    ...
                    $status = $_POST["status"];
                    $sql_update_transection = mysqli_query($con,"UPDATE transection_details SET transection_date='$invoice_date', paid_amount = '$paid_amount',status ='$status' WHERE id = '$trans_id'");
                    $sql_update="UPDATE purchase_invoice SET invoice_date='$invoice_date', discount = '$discount', net_total = '$net_total',amount_paid = '$paid_amount' , remaining = '$remaining' ,status = '$status' where sale_id = '$id'";
