...
<?php  
  ...
  $query_show = "SELECT * FROM distributer WHERE id='$id'";
 ...
 ?>
  ...
  <div class="content-wrapper">
       ...
       if(isset($_POST["submit"]))
    {
      ...
      $query_insert = "UPDATE distributer SET name= '$name', father_name = '$father_name', phone_no ='$phone_no',address = '$address',cnic = '$cnic' WHERE id=$id";
