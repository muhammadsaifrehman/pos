...
$id=$_GET["id"];
$sql = "SELECT pi.*,d.name from purchase_invoice as pi INNER JOIN distributer as d ON d.id = pi.distributer_id where pi.id = '$id' ";
$result = mysqli_query($con,$sql);
$row1 = mysqli_fetch_assoc($result);
$invoice_details="SELECT * FROM products_per_purchase_invoice WHERE purchase_invoice_id = '$id'";
$result_detail = mysqli_query($con,$invoice_details);
$product_item = mysqli_query($con,"SELECT DISTINCT(product_id) FROM products_per_purchase_invoice WHERE purchase_invoice_id = $id");
            ...
            <tbody>
              ...
              while ($row_detail = mysqli_fetch_assoc($result_detail)) {
                ...
                <tr>
                  ...
                  <td style="text-align: center;"><?php echo $row_detail["purchase_price"]; ?></td>
              </tr>
             <?php 
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th style="text-align: center;"><?php echo $row1["total_amount"]; ?></th>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <th style="background-color:white;color:black;">Status</th>
                                  <th style="text-align: center;background-color:<?php echo $background_color;?>;color: white;"><?php echo $row1["status"]; ?></th>
                              </tr>
