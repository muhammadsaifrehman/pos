...
$net_total = $row["total_amount"]-$row["discount"];
?>
          ...
          <div class="col-md-8">
            <div class="box" style="border-top:4px solid #3C8DBC">
              <div class="box-header">
                <h2 style="text-align: center"><b><i>Collect Remaining Sale Invoice</i></b></h2>
            ...
            <div class="box-body">
              <?php
                if (isset($_POST["update"])) {
                    ...
                    $transection = mysqli_query($con,"INSERT INTO transection_details(type,invoice_id,transection_date,paid_amount,status,created_by,created_at) VALUES('sale','$id','$invoice_date','$paid_amount_now','$status','$user','$created_at')");
                    $sql_update="UPDATE sale_invoice SET amount_paid = '$paid_amount' , remaining = '$remaining' ,status = '$status' where sale_id = '$id'";
              ...
              <form method="post">
                  ...
                  <div class="col-md-6 form-group">
                      ...
                      <input type="date" name="transection_date" value="<?php echo $row['invoice_date']; ?>" placeholder="" class='form-control' >          
                    </div>    
                    <div class="col-md-6 form-group">
